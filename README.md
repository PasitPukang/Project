...
เนื่องจากระบบนี้ได้รับการออกแบบตามมาตรฐานความปลอดภัย **จึงไม่มีการแสดงรหัสผ่านค้างบนหน้าจอเว็บ** ผู้ประเมินหรือฝ่าย HR สามารถใช้รหัสทดสอบด้านล่างนี้เพื่อทดลองเข้าใช้งานระบบได้ครับ:
...
### 3. 🔐 รหัสผ่านยกระดับสิทธิ์แอดมิน (Admin Master Passcode)
* หากเข้าใช้งานในฐานะผู้ใช้ทั่วไป แล้วต้องการทดลองสิทธิ์แอดมิน ให้กดที่ป้ายสิทธิ์ผู้ใช้ในแถบเมนูข้างบน แล้วป้อนรหัสแอดมิน:
  👉 **`ADMIN1234`**
